...
//------------------------------Îáùèå ôóíêöèè ğàáîòû ñ èãğîâûìè êîíôèãàìè---------------------------------
  ...
  //---------------------------ñïåöèôè÷åñêèå ôóíêöèè êîíôèãóğàöèè ãàíñà--------------------------------------
...
//-----------------------------------------------------------------------------------------------------------------
  ...
  dof_def_speed:=game_ini_r_single_def(GUNSL_BASE_SECTION, 'default_dof_speed', 5); //äëÿ îğèãèíàëüíîãî çóìà (pick mode)
  dof_def_speed_in:=game_ini_r_single_def(GUNSL_BASE_SECTION, 'default_dof_speed_in', 3); //äëÿ âõîäà â àíèìó
  dof_def_speed_out:=game_ini_r_single_def(GUNSL_BASE_SECTION, 'default_dof_speed_out', 1); //äëÿ âûõîäà èç àíèìû

  dof_def_timeoffset:=game_ini_r_single_def(GUNSL_BASE_SECTION, 'default_dof_time_offset', -0.4); //âğåìÿ âûêëş÷åíèÿ äîôà
