...
//            log(inttostr(GetCurrentState(wpn)));
            if (GetActorTargetSlot()=GetActorActiveSlot()) and ((GetCurrentState(wpn)=EHudStates__eHidden)) and IsActorActionAnimatorAutoshow() and ((@GetActorActionCallback()<>nil) or not game_ini_r_bool_def(sect, 'disable_autochange_slot', false)) then begin
