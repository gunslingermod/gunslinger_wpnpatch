...
begin
  ...
  //[bug] баг - кто-то забыл проинициализировать в CAI_Crow::net_Spawn, из-за чего при неудачном стечении обстоятельств вороны вне сектора обзора не летают... Исправим.
